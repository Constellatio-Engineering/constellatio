...
export const wrapper = ({ hidden, theme }: {
  ...
  theme: MantineTheme;
	...
	.hidden-overlay {
		...
		background: white;
		/* background: linear-gradient(180deg, rgba(255,255,255,0) 0%, ${theme
    .colors["neutrals-01"][0]} 40%); */
		...
		div {
			...
			&::before {
				...
				/* background: linear-gradient(180deg, rgba(255,255,255,0) 63%, ${theme
    .colors["neutrals-01"][0]} 97%); */
			}
		}
	}
`;
