...
const BarChart: FunctionComponent<{readonly chartType: "months" | "days"}> = ({ chartType }) => 
{
  ...
  const monthsData = [3, 0, 6, 2, 5, 8, 0, 12, 10, 1, 0, 1]; // Modify this array based on your data based on container height the max of any bar is 16

  const days = ["MON", "TUE", "WED", "THU", "FRI", "SAT", "SUN"];
  const daysData = [3, 0, 6, 2, 12, 8, 0]; // Modify this array based on your data... based on container height the max of any bar is 16
