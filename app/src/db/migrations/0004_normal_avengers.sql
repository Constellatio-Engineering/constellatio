...
VALUES
    ...
    ('Power User', 'power-user', 'Aktives und engagiertes Forummitglied', 'forum-power-user.svg', 'published'),
    ...
    ('Schlauer Kerl 10', 'smart-guy-10', 'Erreichte eine Punktzahl von 10', 'cases-smart-guy-10.svg', 'published'),
    ('Einer von 100', 'one-of-100', 'Unter den Top 100 Teilnehmern', 'general-1-of-100.svg', 'coming-soon'),
    ...
    ('Spielen und Lernen 3', 'play-and-learn-3', 'Durch 3-maliges Spielen gelernt', 'general-play-and-learn-3.svg', 'published'),
    ...
    ('Liebhaber von Favoriten', 'favorites-collector', 'Du liebst unseren Inhalt', 'general-favourites-1.svg', 'coming-soon'),
    ...
    ('UGC-Uploader 1', 'ugc-uploader-1', 'Erster, der benutzergenerierten Inhalt teilt', 'ugc-upload-1.svg', 'coming-soon'),
