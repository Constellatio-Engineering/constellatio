...
INSERT INTO "constellatio_utils"."EnvironmentVariables" ("Key", "Value", "Description", "Type") VALUES
   (
       'webhook_url',
       'http://host.docker.internal:3010/api/integration/webhooks/supabase',
       'Webhook URL to notify our application backend about data changes',
       'string'
   ),
   (
       'webhook_headers',
       '{"content-type": "application/json", "authorization": "Bearer Our-Supabase-Webhook-Secret"}',
