...
export const allCaseProgressStates = [
  "not-started",
  "completing-tests",
  "solving-case",
  "completed",
...
export const onboardingResultEnum = pgEnum(
  "OnboardingResult",
...
export const searchIndexTypeEnum = pgEnum(
  "SearchIndexType",
  allSearchIndexTypes
);
export const caseProgressStateEnum = pgEnum(
  "CaseProgressState",
  allCaseProgressStates
);
export const gameProgressStateEnum = pgEnum(
  "GameProgressState",
...
export const casesViews = pgTable(
  "CaseView",
  {
    userId: uuid("UserId")
      .references(() => users.id, { onDelete: "no action" })
...
export const articlesViews = pgTable(
  "ArticleView",
  {
    userId: uuid("UserId")
      .references(() => users.id, { onDelete: "no action" })
...
export const casesProgress = pgTable(
  "CaseProgress",
  {
    ...
    userId: uuid("UserId")
      .references(() => users.id, { onDelete: "no action" })
      .notNull(),
    progressState: caseProgressStateEnum("ProgressState")
      .notNull()
      .default("not-started"),
  },
  (table) => ({
    caseId_userId_Index: index("CaseId_UserId_Index").on(
      table.userId,
      table.caseId
    ),
    pk: primaryKey(table.userId, table.caseId),
...
export const gamesProgress = pgTable(
  "GameProgress",
  {
    ...
    userId: uuid("UserId")
      .references(() => users.id, { onDelete: "no action" })
      .notNull(),
    progressState: gameProgressStateEnum("ProgressState")
      .notNull()
      .default("not-started"),
  },
  (table) => ({
    gameId_userId_Index: index("GameId_UserId_Index").on(
      table.userId,
      table.gameId
    ),
...
export type SearchIndexUpdateQueueInsert = InferInsertModel<
  typeof searchIndexUpdateQueue
>;
export type SearchIndexUpdateQueueItem = InferSelectModel<
  typeof searchIndexUpdateQueue
>;
